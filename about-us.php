...
<head>
    ...
    <link rel='stylesheet' id='elementor-post-20-css'
        href='../wp-content/uploads/elementor/css/post-20.css?ver=1731057384' type='text/css' media='all'>
    ...
    <link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed"
        href="../wp-json/oembed/1.0/embed-20?url=https%3A%2F%2Fdemo.casethemes.net%2Forganio%2Fabout%2F">
    <link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed"
        href="../wp-json/oembed/1.0/embed-21?url=https%3A%2F%2Fdemo.casethemes.net%2Forganio%2Fabout%2F&#038;format=xml">
...
<body
    class="page-template-default page page-id-20 theme-orgio woocommerce-no-js woo-variation-swatches wvs-behavior-blur wvs-theme-orgio wvs-show-label wvs-tooltip redux-page  site-h2 body-default-font heading-default-font header-sticky  site-404-default elementor-default elementor-kit-12 elementor-page elementor-page-20">
                            ...
                            <div class="ct-header-product-search">
                                <form action="https://demo.casethemes.net/organio/" class="product-searchform"
                                    ...
                                    <div class="product-search-category"> <select name="product_cat">
                                            ...
                                            <option value="discount-weekly">Discount Weekly</option>
                                            ...
                                            <option value="fresh-nuts">Fresh Nuts</option>
                                            <option value="grocery-frozen">Grocery &amp; Frozen</option>
                                            <option value="millk-cream">Millk Cream</option>
                                            <option value="nature">Nature</option>
                                            <option value="recipies">Recipies</option>
                                            <option value="soya-dairy-free">Soya &amp; Dairy Free</option>
                                            <option value="vegetable">Vegetable</option>
                                        </select></div>
                                    <div class="product-search-meta"> <input type="text" name="s" value=""
                                            placeholder="Search Product"> <button type="submit"
                                            class="btn btn-animate">Search</button> <input type="hidden"
 ...
 c8.271,0,15,6.729,15,15V347z"></path>
                                        </g>
                                    </svg></div>
                                <div class="ct-header-phone-meta"> <label>24/7 Support</label> <a
                                ...
                                <div class="ct-menu-shop">
                                    <ul id="ct-menu-shop" class="ct-main-menu children-arrow ct-menu-shop clearfix">
                                        <li id="menu-item-2231"
                                            ...
                                            <a href="#"><span class="ct-icon-menu"><i></i></span><span>Browse
                                                    Categories</span></a>
                                            <ul class="sub-menu">
                                    ...
                                    <div class="ct-main-navigation-inner">
                                        ...
                                        <ul id="ct-main-menu" class="ct-main-menu children-arrow clearfix">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="elementor-column elementor-col-20 elementor-top-column elementor-element elementor-element-8e89d35"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="elementor-element elementor-element-fb6092b elementor-widget elementor-widget-ct_showcase"
                                                                                    data-id="fb6092b"
                                                                                    data-element_type="widget"
                                                                                    data-widget_type="ct_showcase.default">
                                                                                    <div
                                            ...
                                            <li id="menu-item-2168"
                                                class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-2168">
                                                <a href="#"><span>Pages</span><span class="menu-line"></span><span
                                                        class="menu-icon-plus"></span></a>
                                                <ul class="sub-menu">
                                                    <li id="menu-item-2166"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-20 current_page_item menu-item-2166">
                                                        <a href="index.htm" aria-current="page"><span>About
                                                                Us</span><span class="menu-line"></span><span
                                                    ...
                                                    <li id="menu-item-2409"
                                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-2409">
                                                        <a href="#"><span>User Pages</span><span
                                                                class="menu-line"></span><span
                                                                class="menu-icon-plus"></span></a>
                                                        <ul class="sub-menu">
                                                    ...
                                                    <li id="menu-item-2199"
                                                        ...
                                                        <a href="https://demo.casethemes.net/organio/404-page"><span>404
                                                                Page</span><span class="menu-line"></span><span
                                                                class="menu-icon-plus"></span></a></li>
                                            ...
                                            <li id="menu-item-4526"
                                                class="menu-item menu-item-type-custom menu-item-object-custom megamenu megamenu-style-alt menu-item-has-children menu-item-4526">
                                                <a href="#"><span>Elements</span><span class="menu-line"></span><span
                                                        class="menu-icon-plus"></span></a>
                                                <ul class="sub-menu">
                                                    <li>
                                                        <div class="container">
                            ...
                            <main id="main" class="site-main">
                                <article id="post-20" class="post-20 page type-page status-publish hentry">
                                    <div class="entry-content clearfix">
                                        <div data-elementor-type="wp-page" data-elementor-id="20"
                                            class="elementor elementor-20">
                                            <section
                                                class="elementor-section elementor-top-section elementor-element elementor-element-3844968 elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                                data-id="3844968" data-element_type="section">
                                                <div class="elementor-container elementor-column-gap-extended ">
                                                    <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-44c71b2"
                                                        data-id="44c71b2" data-element_type="column">
                                                        <div class="elementor-widget-wrap elementor-element-populated">
                                                            <section
                                                                class="elementor-section elementor-inner-section elementor-element elementor-element-6a6a11a elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                                                data-id="6a6a11a" data-element_type="section"
                                                                data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                                                                <div
                                                                    class="elementor-container elementor-column-gap-extended ">
                                                                    <div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-57e460e"
                                                                        data-id="57e460e" data-element_type="column">
                                                                        <div
                                                                            class="elementor-widget-wrap elementor-element-populated">
                                                                            <div class="elementor-element elementor-element-bcb7c7f elementor-widget elementor-widget-ct_fancy_box"
                                                                                data-id="bcb7c7f"
                                                                                data-element_type="widget"
                                                                            ...
                                                                            <div class="elementor-element elementor-element-f6fcabc elementor-widget elementor-widget-ct_fancy_box"
                                                                                data-id="f6fcabc"
                                                                                data-element_type="widget"
                                                                                data-widget_type="ct_fancy_box.default">
                                                                                <div class="elementor-widget-container">
                                                                    ...
                                                                    <div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-97d4881"
                                                                        data-id="97d4881" data-element_type="column">
                                                                        <div
                                                                            class="elementor-widget-wrap elementor-element-populated">
                                                                            <div class="elementor-element elementor-element-44f3366 elementor-widget elementor-widget-ct_fancy_box"
                                                                                data-id="44f3366"
                                                                                data-element_type="widget"
                                                                                data-widget_type="ct_fancy_box.default">
                                                                                <div class="elementor-widget-container">
                                                                            ...
                                                                            <div class="elementor-element elementor-element-136960b elementor-widget elementor-widget-ct_fancy_box"
                                                                                data-id="136960b"
                                                                                data-element_type="widget"
                                                                                data-widget_type="ct_fancy_box.default">
                                                                                <div class="elementor-widget-container">
                                                    ...
                                                    <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-40661bf"
                                                        data-id="40661bf" data-element_type="column">
                                                        <div class="elementor-widget-wrap elementor-element-populated">
                                                            <div class="elementor-element elementor-element-16eda0e elementor-widget elementor-widget-ct_heading"
                                                                data-id="16eda0e" data-element_type="widget"
                                                                data-widget_type="ct_heading.default">
                                                                <div class="elementor-widget-container">
                                                            ...
                                                            <div class="elementor-element elementor-element-6607777 elementor-widget elementor-widget-ct_text_editor"
                                                                data-id="6607777" data-element_type="widget"
                                                                data-widget_type="ct_text_editor.default">
                                                                <div class="elementor-widget-container">
                                                                    <div id="ct_text_editor-6607777"
 ...
 "></div>
                                                            ...
                                                            <div class="elementor-element elementor-element-6d46fe5 elementor-widget elementor-widget-ct_text_editor"
                                                                data-id="6d46fe5" data-element_type="widget"
                                                                data-widget_type="ct_text_editor.default">
                                                                <div class="elementor-widget-container">
                                                                    <div id="ct_text_editor-6d46fe5"
                                                                        class="ct-text-editor " data-wow-delay="ms">
                                                                        <div class="ct-item--inner">
                                                                            <div class="ct-inline-css" data-css="
 "></div>
                                            ...
                                            <section
                                                class="elementor-section elementor-top-section elementor-element elementor-element-c795463 elementor-section-stretched elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                                data-id="c795463" data-element_type="section"
                                                data-settings="{&quot;stretch_section&quot;:&quot;section-stretched&quot;,&quot;background_background&quot;:&quot;classic&quot;}">
                                                <div class="elementor-background-overlay"></div>
                                                <div class="elementor-container elementor-column-gap-extended ">
                                                    <div class="elementor-column elementor-col-25 elementor-top-column elementor-element elementor-element-1e63069 ct-col-line1"
                                                        data-id="1e63069" data-element_type="column">
                                                        <div class="elementor-widget-wrap elementor-element-populated">
                                                            <div class="elementor-element elementor-element-c50e1ec ct-counter-layout1 elementor-widget elementor-widget-ct_counter"
                                                                data-id="c50e1ec" data-element_type="widget"
                                                    ...
                                                    <div class="elementor-column elementor-col-25 elementor-top-column elementor-element elementor-element-7310137 ct-col-line1"
                                                        data-id="7310137" data-element_type="column">
                                                        <div class="elementor-widget-wrap elementor-element-populated">
                                                            <div class="elementor-element elementor-element-390d315 ct-counter-layout1 elementor-widget elementor-widget-ct_counter"
                                                                data-id="390d315" data-element_type="widget"
                                                                data-widget_type="ct_counter.default">
                                                                <div class="elementor-widget-container">
                                                                    <div class="ct-counter ct-counter-layout1 style1 "
                                                                        data-wow-delay="ms">
                                                    ...
                                                    <div class="elementor-column elementor-col-25 elementor-top-column elementor-element elementor-element-436b6c7 ct-col-line1"
                                                        data-id="436b6c7" data-element_type="column">
                                                        <div class="elementor-widget-wrap elementor-element-populated">
                                                            <div class="elementor-element elementor-element-a8f02cc ct-counter-layout1 elementor-widget elementor-widget-ct_counter"
                                                                data-id="a8f02cc" data-element_type="widget"
                                                                data-widget_type="ct_counter.default">
                                                                <div class="elementor-widget-container">
                                                                    <div class="ct-counter ct-counter-layout1 style1 "
                                                                        data-wow-delay="ms">
                                                    ...
                                                    <div class="elementor-column elementor-col-25 elementor-top-column elementor-element elementor-element-b1b1133"
                                                        data-id="b1b1133" data-element_type="column">
                                                        <div class="elementor-widget-wrap elementor-element-populated">
                                                            <div class="elementor-element elementor-element-22f0e2d ct-counter-layout1 elementor-widget elementor-widget-ct_counter"
                                                                data-id="22f0e2d" data-element_type="widget"
                                                                data-widget_type="ct_counter.default">
                                                                <div class="elementor-widget-container">
                                                                    <div class="ct-counter ct-counter-layout1 style1 "
                                                                        data-wow-delay="ms">
                                            ...
                                            <section
                                                class="elementor-section elementor-top-section elementor-element elementor-element-15c5afa elementor-section-stretched elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                                data-id="15c5afa" data-element_type="section"
                                                data-settings="{&quot;stretch_section&quot;:&quot;section-stretched&quot;,&quot;background_background&quot;:&quot;classic&quot;}">
                                                <div class="elementor-container elementor-column-gap-extended ">
                                                    <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-8abc3f8"
                                                        data-id="8abc3f8" data-element_type="column">
                                                        <div class="elementor-widget-wrap elementor-element-populated">
                                                            <section
                                                                class="elementor-section elementor-inner-section elementor-element elementor-element-7ac5c32 elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                                                data-id="7ac5c32" data-element_type="section">
                                                                <div
                                                                    class="elementor-container elementor-column-gap-extended ">
                                                                    <div class="elementor-column elementor-col-33 elementor-inner-column elementor-element elementor-element-26c6b73"
                                                                        data-id="26c6b73" data-element_type="column">
                                                                        <div class="elementor-widget-wrap"></div>
                                                                    </div>
                                                                    <div class="elementor-column elementor-col-33 elementor-inner-column elementor-element elementor-element-c5f6e27"
                                                                        data-id="c5f6e27" data-element_type="column">
                                                                        <div
                                                                            class="elementor-widget-wrap elementor-element-populated">
                                                                            <div class="elementor-element elementor-element-d53d11c elementor-widget elementor-widget-ct_heading"
                                                                                data-id="d53d11c"
                                                                                data-element_type="widget"
                                                                                data-widget_type="ct_heading.default">
                                                                                <div class="elementor-widget-container">
                                                                    ...
                                                                    <div class="elementor-column elementor-col-33 elementor-inner-column elementor-element elementor-element-37ceda1"
                                                                        data-id="37ceda1" data-element_type="column">
                                                                        <div class="elementor-widget-wrap"></div>
                                                                    </div>
                                                                </div>
                                                            </section>
                                                            <div class="elementor-element elementor-element-ddf77ee elementor-widget elementor-widget-ct_team_carousel"
                                                                data-id="ddf77ee" data-element_type="widget"
                                            ...
                                            <section
                                                class="elementor-section elementor-top-section elementor-element elementor-element-5e0b9f0 elementor-section-stretched elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                                data-id="5e0b9f0" data-element_type="section"
                                                data-settings="{&quot;stretch_section&quot;:&quot;section-stretched&quot;,&quot;background_background&quot;:&quot;classic&quot;}">
                                                <div class="elementor-container elementor-column-gap-extended ">
                                                    <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-cf73a59"
                                                        data-id="cf73a59" data-element_type="column">
                                                        <div class="elementor-widget-wrap elementor-element-populated">
                                                            <div class="elementor-element elementor-element-ef70fd1 elementor-widget elementor-widget-ct_image"
                                                                data-id="ef70fd1" data-element_type="widget"
                                                                data-widget_type="ct_image.default">
                                                                <div class="elementor-widget-container">
                                                                    <div class="ct-image-single    effect-none "
                                                                        data-width="" data-height=""> <img
                                                                            loading="lazy" decoding="async" width="675"
                                                                            height="503"
                                                                            src="../wp-content/uploads/2021/03/about-img1.jpg"
                                                    ...
                                                    <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-ea3261c"
                                                        data-id="ea3261c" data-element_type="column">
                                                        <div class="elementor-widget-wrap elementor-element-populated">
                                                            <div class="elementor-element elementor-element-3ecfbce elementor-widget elementor-widget-ct_heading"
                                                                data-id="3ecfbce" data-element_type="widget"
                                                                data-widget_type="ct_heading.default">
                                                                <div class="elementor-widget-container">
                                                                    <div class="ct-heading h-align- item-st-default">
                                                                        <div class="ct-heading--inner">
                                                            ...
                                                            <div class="elementor-element elementor-element-d0d4f73 elementor-widget elementor-widget-ct_text_editor"
                                                                data-id="d0d4f73" data-element_type="widget"
                                                                data-widget_type="ct_text_editor.default">
                                                                <div class="elementor-widget-container">
                                                                    <div id="ct_text_editor-d0d4f73"
                                                                        class="ct-text-editor " data-wow-delay="ms">
                                                                        <div class="ct-item--inner">
                                                                            <div class="ct-inline-css" data-css="
 "></div>
                                                            ...
                                                            <div class="elementor-element elementor-element-9266724 elementor-widget elementor-widget-ct_text_editor"
                                                                data-id="9266724" data-element_type="widget"
                                                                data-widget_type="ct_text_editor.default">
                                                                <div class="elementor-widget-container">
                                                                    <div id="ct_text_editor-9266724"
                                                                        class="ct-text-editor " data-wow-delay="ms">
                                                                        <div class="ct-item--inner">
                                                                            <div class="ct-inline-css" data-css="
 "></div>
                                                            ...
                                                            <section
                                                                class="elementor-section elementor-inner-section elementor-element elementor-element-1b6ef73 elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                                                                data-id="1b6ef73" data-element_type="section">
                                                                <div
                                                                    class="elementor-container elementor-column-gap-extended ">
                                                                    <div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-49c40ea"
                                                                        data-id="49c40ea" data-element_type="column">
                                                                        <div
                                                                            class="elementor-widget-wrap elementor-element-populated">
                                                                            <div class="elementor-element elementor-element-da3daf7 elementor-widget elementor-widget-ct_fancy_box"
                                                                                data-id="da3daf7"
                                                                                data-element_type="widget"
                                                                                data-widget_type="ct_fancy_box.default">
                                                                                <div class="elementor-widget-container">
                                                                    ...
                                                                    <div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-8731797"
                                                                        data-id="8731797" data-element_type="column">
                                                                        <div
                                                                            class="elementor-widget-wrap elementor-element-populated">
                                                                            <div class="elementor-element elementor-element-11b70e4 elementor-widget elementor-widget-ct_fancy_box"
                                                                                data-id="11b70e4"
                                                                                data-element_type="widget"
                                                                                data-widget_type="ct_fancy_box.default">
                                                                                <div class="elementor-widget-container">
                                                                        ...
                                                                        <div id="ct_navigation_menu-de5fd21"
                                                                            ...
                                                                            <div class="menu-menu-footer-container">
                                                                                <ul id="menu-menu-footer" class="menu">
                                                                                    ...
                                                                                    <li id="menu-item-62"
                                                                                        class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-20 current_page_item menu-item-62">
                                                                                        <a href="index.htm"
                                                                                            aria-current="page"><span>About
                                                                                                us</span></a></li>
                                                                                    <li id="menu-item-979"
                ...
                <div class="woosc-popup-content-inner">
                    ...
                    <ul class="woosc-settings-tools">
                        ...
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="q97v" checked/=""><span class="move">Image</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="m65g" checked/=""><span class="move">SKU</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="2hsr" checked/=""><span class="move">Rating</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="0prk" checked/=""><span class="move">Price</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="0em3" checked/=""><span class="move">Stock</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="b773" checked/=""><span class="move">Availability</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="yzqk" checked/=""><span class="move">Add to cart</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="1gsg" checked/=""><span class="move">Description</span></li>
                        <li class="woosc-settings-field-li"><input type="checkbox" class="woosc-settings-field"
                                value="j3mc" checked/=""><span class="move">Weight</span></li>
                    </ul>
                </div>
            </div>
        </div>
